    ...
    <div className="space-y-16 pb-20">
      ...
      <section id="products" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Our Collection</h2>
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-20">
            <ShoppingBag className="h-16 w-16 text-gray-200 dark:text-gray-800 mx-auto mb-4" />
      ...
      {/* Newsletter */}
      <section className="bg-indigo-600 dark:bg-indigo-900 py-16 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="max-w-md mx-auto flex gap-2">
            ...
            />
            <button className="px-8 py-3 bg-white text-indigo-600 dark:text-indigo-900 font-bold rounded-full hover:bg-indigo-50 transition-colors">
              Join
            </button>
          </form>
        </div>
